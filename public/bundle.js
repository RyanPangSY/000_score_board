...
(() => {
  ...
  function setTeamName(team, name3) {
    if (team === "red") {
      redTeamName = name3;
      blueTeamName = name3 === "Lebron James" ? "Michael Jordan" : "Lebron James";
    } else {
      blueTeamName = name3;
      redTeamName = name3 === "Lebron James" ? "Michael Jordan" : "Lebron James";
    }
  }
  function startGame() {
    if (!isGameRunning) {
  ...
  async function setupAudio() {
    ...
    introBuffer = await loadAudio("/000_score_board/assets/Intro.mp3");
  }
  setupAudio();
  ...
  window.addEventListener("DOMContentLoaded", () => {
    ...
    if (intro && introText) {
      ...
      introText.style.animation = "introTextFadeIn 1.2s cubic-bezier(.4,0,.2,1) forwards, introTextShadow 0.7s 0.5s cubic-bezier(.4,0,.2,1) forwards";
      setTimeout(() => {
  ...
  function unlockAudio() {
    ...
    introBuffer.play().then(() => introBuffer.pause());
